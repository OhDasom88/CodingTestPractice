...
단, 바닥은 벽면의 맨 아래 지면을 말합니다.
'''
def solution(n:int, build_frame:list):
    frame = [[-1 for x in range(n+1)] for y in range(n+1)]
    tmp = {}
